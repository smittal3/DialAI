...
class VoiceDetection(BaseThread):
    def __init__(self, 
        ...
        super().__init__(name="VoiceDetection")
    ...
    def _run_process(self):
        ...
        while self.is_running:
            try:
                ...
                # This is still 20 frames after the user has supposedly stopped speaking but trying to detect it early
